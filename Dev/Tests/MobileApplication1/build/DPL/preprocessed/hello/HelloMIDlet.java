    ...
    public void commandAction(Command command, Displayable displayable) {//GEN-END:|7-commandAction|0|7-preCommandAction
        ...
        if (displayable == form) {//GEN-BEGIN:|7-commandAction|1|19-preAction
            if (command == exitCommand) {//GEN-END:|7-commandAction|1|19-preAction
                ...
                // write post-action user code here
            } else if (command == itemCommand) {//GEN-LINE:|7-commandAction|3|27-preAction
                // write pre-action user code here
                getConnected();
//GEN-LINE:|7-commandAction|4|27-postAction
    ...
    private void getConnected() {
        ...
        try {
            HttpsConnection sc = (HttpsConnection) Connector.open("https://cabinet.salyk.kz");
...
*/
            stringItem.setText(String.valueOf(val++));//s.toString());
            //in.close();
            //os.close();
//            is.close();
            ...
            ex.printStackTrace();
            stringItem.setText(ex.getMessage());
        }
    }
